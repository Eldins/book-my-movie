    ...
    <body>
        ...
        <table align="center" border="1">
            ...
            <%    
                ...
                String sel = "select * from tbl_theaterregistration d,tbl_place p,tbl_theaterclass t,tbl_district c where d.place_id=p.place_id and t.theaterclass_id=d.theaterclass_id and c.district_id = p.district_id and theater_status='1'";
